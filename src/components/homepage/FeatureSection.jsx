...
function FeatureSection() {
  ...
  return (
    <section
      className="xl:py-20 sm:py-10 font-sans section dark:bg-gray-900 sm:px-10"
      name="features"
    >
      <div className="flex flex-col justify-center items-center gap-6">
        <h2 className="sm:text-2xl xl:text-4xl text-primary font-semibold">
          Why Choose Showcase?
        </h2>
        <p className="sm:text-[16px] xl:text-lg dark:text-gray-100">
      ...
      <motion.div
        ...
        ref={ref}
        animate={controls}
        className="grid sm:grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 xl:mx-20 sm:mx-10 gap-4 mt-10"
      >
        <CardFeature
